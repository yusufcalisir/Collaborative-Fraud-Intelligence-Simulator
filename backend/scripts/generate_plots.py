...
def run_simulation_run(config, bank_data, fl_engine, model_service, privacy_service, metrics_service):
...
def main():
    ...
    # Accuracy Plot
    axes[0].plot(rounds_range, [m.accuracy for m in metrics_fed_avg_clean], 'g-o', label='FedAvg (Clean)', linewidth=2)
    axes[0].plot(rounds_range, [m.accuracy for m in metrics_fed_avg_poisoned], 'r-x', label='FedAvg (Poisoned by Bank C)', linewidth=2)
    axes[0].plot(rounds_range, [m.accuracy for m in metrics_krum_poisoned], 'b-^', label='Krum (Poisoned by Bank C)', linewidth=2)
    ...
    # F1-Score Plot
    axes[1].plot(rounds_range, [m.f1_score for m in metrics_fed_avg_clean], 'g-o', label='FedAvg (Clean)', linewidth=2)
    axes[1].plot(rounds_range, [m.f1_score for m in metrics_fed_avg_poisoned], 'r-x', label='FedAvg (Poisoned by Bank C)', linewidth=2)
    axes[1].plot(rounds_range, [m.f1_score for m in metrics_krum_poisoned], 'b-^', label='Krum (Poisoned by Bank C)', linewidth=2)
    ...
    # F1-Score
    axes[0].plot(rounds_range, [m.f1_score for m in metrics_fed_avg_clean], 'g-o', label='FedAvg (DP OFF)', linewidth=2)
    axes[0].plot(rounds_range, [m.f1_score for m in metrics_fed_avg_dp], 'm-s', label='FedAvg (DP ON, ε=2.0)', linewidth=2)
    ...
    # AUC-ROC
    axes[1].plot(rounds_range, [m.auc_roc for m in metrics_fed_avg_clean], 'g-o', label='FedAvg (DP OFF)', linewidth=2)
    axes[1].plot(rounds_range, [m.auc_roc for m in metrics_fed_avg_dp], 'm-s', label='FedAvg (DP ON, ε=2.0)', linewidth=2)
